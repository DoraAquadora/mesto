export class FormValidator {
  ...
  _validateInput(event) {
      ...
      this._isValidField();//fffffffff
      this._isValidButtonAndInput();
  }
  _isValidField() {
      this._errorSpan = this._form.querySelector(`.${this._input.id}-error`);//fffffffff
      this._errorSpan.textContent = this._input.validationMessage;//fffffffff
  }
