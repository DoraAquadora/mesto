...
const buttonSubmitProfileForm = document.querySelector('.popup__submit-button_profile');
const buttonSubmitAddCardForm = document.querySelector('.popup__submit-button_place');
